...
class GetHighlightedMoviesUseCase extends UseCase<List<MovieEntity>> {
  final HomeRepo _homeRepo;

  GetHighlightedMoviesUseCase(this._homeRepo);

  @override
  Future<Either<Failure, List<MovieEntity>>> call() async {
    return await _homeRepo.getHighlightedMovies();
  }
}
